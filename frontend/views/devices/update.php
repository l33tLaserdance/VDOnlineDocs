...
$this->title = 'Редактирование устройства "'.$model->device_type.' '.$model->device_name.'".';
...
$this->params['breadcrumbs'][] = ['label' => $model->device_type.' '.$model->device_name, 'url' => ['/devices/view', 'id' => $model->device_id], 'style' => 'color: green;'];
