...
$this->title = 'Добавление шкафа к объекту "'.$_SESSION['obj_name'].'"';
...
$this->params['breadcrumbs'][] = ['label' => $_SESSION['obj_name'], 'url' => ['/objects/view', 'id' => $_SESSION['org_id'], 'org' => $_SESSION['org_full_name']], 'style' => 'color: green;'];
